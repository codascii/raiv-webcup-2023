					...
					<div className="row">
						<div className="col-lg-3 col-md-6">
							...
							>
								...
								<p>
									L'Institut International des Rêves est une
									initiative ambitieuse visant à explorer et à
									comprendre le monde des rêves. Le but de
									l'institut est de rassembler des chercheurs,
							...
							>
								...
								<ul className="information">
									...
									<li className="address">
										...
										<span>Address</span>
										123, rue des étoiles 97600 Mamoudzou,
										MAYOTTE
									</li>
								</ul>
							</div>
					...
					<div className="row align-items-center">
						<div className="col-lg-4">
							<div className="copy-right">
								<p>
									Droit d'auteur &copy; {currentYear} Tous les
